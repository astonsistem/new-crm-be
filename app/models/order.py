...
class Order_Service(Base):
    ...
    service_point_id = Column(UUID(as_uuid=True), ForeignKey("service_points.id"), nullable=True)
    ...
    service_point = relationship("Service_Point", back_populates="service_orders")
